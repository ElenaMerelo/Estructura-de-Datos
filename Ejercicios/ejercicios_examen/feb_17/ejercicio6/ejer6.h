...
public:
   ...
   */
   ...
   /**
   @brief Obtiene el nodo con la etiqueta pasada como parámetro
   ...
   */
   ...
   /**
    ...
    @return nodo en la posición position
    */
    Nodo at(int position);

  /**
   @brief Devuelve la trayectoria de un nodo, esto es, la suma del contenido de
   * todos los nodos desde al raíz hasta la hoja multiplicada por el nivel en el
   * que se encuentra cada nodo.
   @param n nodo del que se quiere saber la trayectoria
   @return trayectoria de n
   */
   int trayectoria(int position);
