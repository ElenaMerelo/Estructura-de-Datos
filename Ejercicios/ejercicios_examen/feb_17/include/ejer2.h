...
public:
  ...
  matriz_bilineal_simetrica(const vector<T> &v);
  ...
  typedef typename vector<vector<T> >::iterator my_iterator;


  //Iterador constante para recorrer el vector<vector<T> > que contiene los eventos
  typedef typename vector<vector<T> >::const_iterator my_const_iterator;

  //Iterador que recorre la matriz en orden inverso
  typedef typename vector<vector<T> >::reverse_iterator my_reverse_iterator;

  //Iterador que recorre la matriz en orden inverso
  typedef typename vector<vector<T> >::const_reverse_iterator my_const_reverse_iterator;
