...
public:
  ...
  /**
   @brief Devuelve el número de niveles de un árbol
   */
   int num_levels();

  /**
   @brief Almacena las etiquetas de los nodos entre los niveles n1 y n2
   @param n1 nivel 1 desde el cual se recorre
   @param n2 nivel hasta el cual se recorre
   @param v vector en el que se almacenan las etiquetas de los nodos recorridos
   */
   void etiquetas_entre(int n1, int n2, vector<Tbase> &v);
